...
private boolean validateInputs()
    {
        return !(txtTrainNo.getText().trim().isEmpty()||txtamt.getText().trim().isEmpty()||txtName.getText().trim().isEmpty()||txtTicketNo.getText().trim().isEmpty()||txtMobNo.getText().trim().isEmpty());
    }
    /**
    ...
    private void initComponents() {
        ...
        jctrain = new javax.swing.JComboBox<>();
        jccoach = new javax.swing.JComboBox<>();
        ...
        jctrain.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BPL - DEL", "BPL - GWA", " " }));
        jctrain.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jctrainActionPerformed(evt);
            }
        });

        jccoach.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "FIRST_AC_FARE", "SECOND_AC_FARE", "THIRD_AC_FARE", " " }));
        jccoach.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jccoachActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtMobNo, javax.swing.GroupLayout.DEFAULT_SIZE, 189, Short.MAX_VALUE)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtamt)
                    .addComponent(jctrain, 0, 109, Short.MAX_VALUE)
                    .addComponent(jccoach, 0, 1, Short.MAX_VALUE))
                .addGap(30, 30, 30))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jctrain, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(41, 41, 41)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(jLabel5)
                    .addComponent(txtName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jccoach, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(31, 31, 31)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jctrainActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jctrainActionPerformed
        // TODO add your handling code here:
        String t=jctrain.getSelectedItem().toString();
        String c=jccoach.getSelectedItem().toString();
        try{
        amt=passengerDAO.getamount(t,c)+"";
        txtamt.setText(amt);
        txtTrainNo.setText(passengerDAO.Train_No(t)+"");
        }
    ...
    }//GEN-LAST:event_jctrainActionPerformed

    private void jccoachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jccoachActionPerformed
        // TODO add your handling code here:
        String t=jctrain.getSelectedItem().toString();
        String c=jccoach.getSelectedItem().toString();
        try{
    ...
    }//GEN-LAST:event_jccoachActionPerformed
    ...
    private void btnDoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDoneActionPerformed
        ...
        try{
            String s=jccoach.getSelectedItem().toString().trim();
            passengerPojo p=new passengerPojo();
            p.setPname(txtName.getText().trim());
            p.setTicketno(txtTicketNo.getText().trim());
            p.setMobno(Long.parseLong(txtMobNo.getText().trim()));
            p.setTamount(Integer.parseInt(txtamt.getText().trim()));
            p.setTno(Integer.parseInt(txtTrainNo.getText().trim()));;
            p.setCoach(s);
...
LoginForm mframe=new LoginForm();
    ...
    private javax.swing.JComboBox<String> jccoach;
    private javax.swing.JComboBox<String> jctrain;
...
private void getNewTrainNo() {
        try{
            String tno=passengerDAO.getNextTrainNo();
            txtTicketNo.setText(tno);
        }
        catch(SQLException ex)
        {
            JOptionPane.showMessageDialog(null,"Db Error!","Error!",JOptionPane.ERROR_MESSAGE);
...
private void cleartext() {
        ...
        txtMobNo.setText("");
        txtTicketNo.setText("");
        jctrain.setSelectedIndex(0);
        jccoach.setSelectedIndex(0);
        txtTrainNo.setText("");
        txtamt.setText("");
    }
}
